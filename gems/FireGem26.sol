...
contract FireGem26 is IFireGem26 {
    uint256 private constant GEM_ID = 26;
    string private constant SCHOOL = "Fire";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 234;
    uint256 private constant TOTAL_VALUE = 252;
    uint256 private constant SOCKET_LEVEL = 3;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Burning";
    ...
    // Suffix Modifier
    string private constant SUFFIX_NAME = "of Embers";
