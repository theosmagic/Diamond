...
/**
 * Infernal Fire Gem of Conflagration
 * ID: 22
 * School: Fire
 * Rarity: Rare
 * Base Value: 198
...
contract FireGem22 is IFireGem22 {
    uint256 private constant GEM_ID = 22;
    string private constant SCHOOL = "Fire";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 198;
    uint256 private constant TOTAL_VALUE = 235;
    uint256 private constant SOCKET_LEVEL = 3;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Infernal";
