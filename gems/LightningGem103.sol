...
contract LightningGem103 is ILightningGem103 {
    uint256 private constant GEM_ID = 103;
    string private constant SCHOOL = "Lightning";
    string private constant RARITY = "Normal";
    uint256 private constant BASE_VALUE = 927;
    uint256 private constant TOTAL_VALUE = 927;
