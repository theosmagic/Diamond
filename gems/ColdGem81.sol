...
/**
 * Frost Cold Gem of Absolute Zero
 * ID: 81
 * School: Cold
 * Rarity: Epic
 * Base Value: 729
...
contract ColdGem81 is IColdGem81 {
    uint256 private constant GEM_ID = 81;
    string private constant SCHOOL = "Cold";
    string private constant RARITY = "Epic";
    uint256 private constant BASE_VALUE = 729;
    uint256 private constant TOTAL_VALUE = 1136;
