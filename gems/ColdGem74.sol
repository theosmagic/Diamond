...
contract ColdGem74 is IColdGem74 {
    uint256 private constant GEM_ID = 74;
    string private constant SCHOOL = "Cold";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 666;
    uint256 private constant TOTAL_VALUE = 688;
    uint256 private constant SOCKET_LEVEL = 8;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Chilling";
