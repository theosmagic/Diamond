...
contract ColdGem75 is IColdGem75 {
    uint256 private constant GEM_ID = 75;
    string private constant SCHOOL = "Cold";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 675;
    uint256 private constant TOTAL_VALUE = 698;
    uint256 private constant SOCKET_LEVEL = 8;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Freezing";
