...
/**
 * Arctic Cold Gem of Winter
 * ID: 80
 * School: Cold
 * Rarity: Rare
 * Base Value: 720
 * Total Value: 1092
 * Socket Level Required: 9
 * Prefix: Arctic (Multiplicative)\n * Suffix: of Winter (Additive)
 * 
 * This gem can be socketed into a Diamond contract.
 * Acts as a neuron in the Diamond nervous system.
 */

interface IColdGem80 {
...
contract ColdGem80 is IColdGem80 {
    uint256 private constant GEM_ID = 80;
    string private constant SCHOOL = "Cold";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 720;
    uint256 private constant TOTAL_VALUE = 1092;
    uint256 private constant SOCKET_LEVEL = 9;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Arctic";
    ...
    // Suffix Modifier
    string private constant SUFFIX_NAME = "of Winter";
