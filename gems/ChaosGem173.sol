...
contract ChaosGem173 is IChaosGem173 {
    uint256 private constant GEM_ID = 173;
    string private constant SCHOOL = "Chaos";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 1557;
    uint256 private constant TOTAL_VALUE = 1876;
    uint256 private constant SOCKET_LEVEL = 18;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Entropic";
