...
/**
 * Oblivion Chaos Gem of Disorder
 * ID: 174
 * School: Chaos
 * Rarity: Rare
 * Base Value: 1566
 * Total Value: 2583
 * Socket Level Required: 18
 * Prefix: Oblivion (Multiplicative)\n * Suffix: of Disorder (Multiplicative)
 * 
 * This gem can be socketed into a Diamond contract.
 * Acts as a neuron in the Diamond nervous system.
 */

interface IChaosGem174 {
...
contract ChaosGem174 is IChaosGem174 {
    uint256 private constant GEM_ID = 174;
    string private constant SCHOOL = "Chaos";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 1566;
    uint256 private constant TOTAL_VALUE = 2583;
    uint256 private constant SOCKET_LEVEL = 18;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Oblivion";
    uint256 private constant PREFIX_VALUE = 1.5;
    string private constant PREFIX_TYPE = "Multiplicative";
    
    
    
    // Suffix Modifier
    string private constant SUFFIX_NAME = "of Disorder";
    uint256 private constant SUFFIX_VALUE = 1.1;
