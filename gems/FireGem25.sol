...
contract FireGem25 is IFireGem25 {
    uint256 private constant GEM_ID = 25;
    string private constant SCHOOL = "Fire";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 225;
    uint256 private constant TOTAL_VALUE = 297;
    uint256 private constant SOCKET_LEVEL = 3;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Blazing";
    ...
    // Suffix Modifier
    string private constant SUFFIX_NAME = "of Intensity";
