...
contract LightningGem110 is ILightningGem110 {
    uint256 private constant GEM_ID = 110;
    string private constant SCHOOL = "Lightning";
    string private constant RARITY = "Normal";
    uint256 private constant BASE_VALUE = 990;
    uint256 private constant TOTAL_VALUE = 990;
