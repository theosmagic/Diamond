...
contract ChaosGem178 is IChaosGem178 {
    uint256 private constant GEM_ID = 178;
    string private constant SCHOOL = "Chaos";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 1602;
    uint256 private constant TOTAL_VALUE = 1789;
    uint256 private constant SOCKET_LEVEL = 18;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Abyssal";
