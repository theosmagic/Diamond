...
/**
 * Burning Fire Gem of Conflagration
 * ID: 40
 * School: Fire
 * Rarity: Epic
 * Base Value: 360
...
contract FireGem40 is IFireGem40 {
    uint256 private constant GEM_ID = 40;
    string private constant SCHOOL = "Fire";
    string private constant RARITY = "Epic";
    uint256 private constant BASE_VALUE = 360;
    uint256 private constant TOTAL_VALUE = 382;
