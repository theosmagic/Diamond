...
/**
 * Blazing Fire Gem of Conflagration
 * ID: 45
 * School: Fire
 * Rarity: Legendary
 * Base Value: 405
...
contract FireGem45 is IFireGem45 {
    uint256 private constant GEM_ID = 45;
    string private constant SCHOOL = "Fire";
    string private constant RARITY = "Legendary";
    uint256 private constant BASE_VALUE = 405;
    uint256 private constant TOTAL_VALUE = 498;
