...
contract ChaosGem185 is IChaosGem185 {
    uint256 private constant GEM_ID = 185;
    string private constant SCHOOL = "Chaos";
    string private constant RARITY = "Epic";
    uint256 private constant BASE_VALUE = 1665;
    uint256 private constant TOTAL_VALUE = 1848;
    uint256 private constant SOCKET_LEVEL = 19;
    bool private constant CAN_COMBINE = false;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Void";
