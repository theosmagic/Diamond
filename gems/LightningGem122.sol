...
/**
 * Voltaic Lightning Gem of Thunder
 * ID: 122
 * School: Lightning
 * Rarity: Rare
 * Base Value: 1098
...
contract LightningGem122 is ILightningGem122 {
    uint256 private constant GEM_ID = 122;
    string private constant SCHOOL = "Lightning";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 1098;
    uint256 private constant TOTAL_VALUE = 1712;
    uint256 private constant SOCKET_LEVEL = 13;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Voltaic";
