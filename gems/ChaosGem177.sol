...
contract ChaosGem177 is IChaosGem177 {
    uint256 private constant GEM_ID = 177;
    string private constant SCHOOL = "Chaos";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 1593;
    uint256 private constant TOTAL_VALUE = 1615;
    uint256 private constant SOCKET_LEVEL = 18;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Chaotic";
    uint256 private constant PREFIX_VALUE = 10;
    string private constant PREFIX_TYPE = "Additive";
    
    
    
    // Suffix Modifier
    string private constant SUFFIX_NAME = "of Entropy";
    uint256 private constant SUFFIX_VALUE = 12;
