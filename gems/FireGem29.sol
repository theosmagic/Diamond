...
/**
 * Scorching Fire Gem of Conflagration
 * ID: 29
 * School: Fire
 * Rarity: Rare
 * Base Value: 261
 * Total Value: 403
 * Socket Level Required: 3
 * Prefix: Scorching (Multiplicative)\n * Suffix: of Conflagration (Additive)
 * 
 * This gem can be socketed into a Diamond contract.
 * Acts as a neuron in the Diamond nervous system.
 */

interface IFireGem29 {
...
contract FireGem29 is IFireGem29 {
    uint256 private constant GEM_ID = 29;
    string private constant SCHOOL = "Fire";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 261;
    uint256 private constant TOTAL_VALUE = 403;
    uint256 private constant SOCKET_LEVEL = 3;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Scorching";
    ...
    // Suffix Modifier
    string private constant SUFFIX_NAME = "of Conflagration";
