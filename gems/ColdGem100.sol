...
contract ColdGem100 is IColdGem100 {
    uint256 private constant GEM_ID = 100;
    string private constant SCHOOL = "Cold";
    string private constant RARITY = "Legendary";
    uint256 private constant BASE_VALUE = 900;
    uint256 private constant TOTAL_VALUE = 937;
