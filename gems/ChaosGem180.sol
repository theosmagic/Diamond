...
contract ChaosGem180 is IChaosGem180 {
    uint256 private constant GEM_ID = 180;
    string private constant SCHOOL = "Chaos";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 1620;
    uint256 private constant TOTAL_VALUE = 2438;
    uint256 private constant SOCKET_LEVEL = 19;
    ...
    // Suffix Modifier
    string private constant SUFFIX_NAME = "of Void";
    uint256 private constant SUFFIX_VALUE = 8;
