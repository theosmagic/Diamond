...
/**
 * Freezing Cold Gem of Absolute Zero
 * ID: 72
 * School: Cold
 * Rarity: Rare
 * Base Value: 648
...
contract ColdGem72 is IColdGem72 {
    uint256 private constant GEM_ID = 72;
    string private constant SCHOOL = "Cold";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 648;
    uint256 private constant TOTAL_VALUE = 861;
    ...
    // Suffix Modifier
    string private constant SUFFIX_NAME = "of Absolute Zero";
