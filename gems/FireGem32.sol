...
/**
 * Infernal Fire Gem of Annihilation
 * ID: 32
 * School: Fire
 * Rarity: Epic
 * Base Value: 288
...
contract FireGem32 is IFireGem32 {
    uint256 private constant GEM_ID = 32;
    string private constant SCHOOL = "Fire";
    string private constant RARITY = "Epic";
    uint256 private constant BASE_VALUE = 288;
    uint256 private constant TOTAL_VALUE = 406;
