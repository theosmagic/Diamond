...
/**
 * Burning Fire Gem of Annihilation
 * ID: 37
 * School: Fire
 * Rarity: Epic
 * Base Value: 333
...
contract FireGem37 is IFireGem37 {
    uint256 private constant GEM_ID = 37;
    string private constant SCHOOL = "Fire";
    string private constant RARITY = "Epic";
    uint256 private constant BASE_VALUE = 333;
    uint256 private constant TOTAL_VALUE = 445;
