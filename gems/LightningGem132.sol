...
contract LightningGem132 is ILightningGem132 {
    uint256 private constant GEM_ID = 132;
    string private constant SCHOOL = "Lightning";
    string private constant RARITY = "Epic";
    uint256 private constant BASE_VALUE = 1188;
    uint256 private constant TOTAL_VALUE = 1317;
    uint256 private constant SOCKET_LEVEL = 14;
    bool private constant CAN_COMBINE = false;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Shocking";
