...
/**
 * Scorching Fire Gem of Annihilation
 * ID: 27
 * School: Fire
 * Rarity: Rare
 * Base Value: 243
...
contract FireGem27 is IFireGem27 {
    uint256 private constant GEM_ID = 27;
    string private constant SCHOOL = "Fire";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 243;
    uint256 private constant TOTAL_VALUE = 473;
