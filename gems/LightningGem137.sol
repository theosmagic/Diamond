...
/**
 * Electrifying Lightning Gem of Voltage
 * ID: 137
 * School: Lightning
 * Rarity: Epic
 * Base Value: 1233
...
contract LightningGem137 is ILightningGem137 {
    uint256 private constant GEM_ID = 137;
    string private constant SCHOOL = "Lightning";
    string private constant RARITY = "Epic";
    uint256 private constant BASE_VALUE = 1233;
    uint256 private constant TOTAL_VALUE = 1372;
    uint256 private constant SOCKET_LEVEL = 14;
    bool private constant CAN_COMBINE = false;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Electrifying";
