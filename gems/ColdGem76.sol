...
contract ColdGem76 is IColdGem76 {
    uint256 private constant GEM_ID = 76;
    string private constant SCHOOL = "Cold";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 684;
    uint256 private constant TOTAL_VALUE = 779;
    uint256 private constant SOCKET_LEVEL = 8;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Glacial";
