...
/**
 * Storm Lightning Gem of Voltage
 * ID: 127
 * School: Lightning
 * Rarity: Rare
 * Base Value: 1143
 * Total Value: 1885
 * Socket Level Required: 13
 * Prefix: Storm (Multiplicative)\n * Suffix: of Voltage (Multiplicative)
 * 
 * This gem can be socketed into a Diamond contract.
 * Acts as a neuron in the Diamond nervous system.
 */

interface ILightningGem127 {
...
contract LightningGem127 is ILightningGem127 {
    uint256 private constant GEM_ID = 127;
    string private constant SCHOOL = "Lightning";
    string private constant RARITY = "Rare";
    uint256 private constant BASE_VALUE = 1143;
    uint256 private constant TOTAL_VALUE = 1885;
    uint256 private constant SOCKET_LEVEL = 13;
    bool private constant CAN_COMBINE = true;
    
    
    // Prefix Modifier
    string private constant PREFIX_NAME = "Storm";
    ...
    // Suffix Modifier
    string private constant SUFFIX_NAME = "of Voltage";
